...
const file_meshtastic_interdevice_proto_rawDesc = "" +
	...
	"\n" +
	"TVOC_INDEX\x10\xb5\x01B\xa7\x01\n" +
	"\x0ecom.meshtasticB\x10InterdeviceProtoP\x01Z8github.com/egonelbre/exp-protobuf-compression/meshtastic\xa2\x02\x03MXX\xaa\x02\n" +
